...
- `rvm use 2.7.2`
- `git clone https://gitlab.com/joanna.code/checkout-system.git`
- `rake test`


Assumptions:

- promotional rules order matters and they apply one on another
...
- add rubocop
- we can devide rules into basket rules and item rules
- we can add validations, for example if price is bigger than 0
- we can use csv instead of yml.... or a database
- use ruby 3.0 :-)
